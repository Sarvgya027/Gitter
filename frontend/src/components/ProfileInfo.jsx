...
import { RiGitRepositoryFill, RiUserFollowFill, RiUserFollowLine, RiUserUnfollowFill, RiUserUnfollowLine } from "react-icons/ri";
        ...
        {/* Location */}
			...
			<div className='flex flex-wrap gap-2 mx-4'>
				...
				<div className='flex items-center gap-2 bg-glass rounded-lg p-2 flex-1 min-w-24'>
					<RiUserUnfollowFill className='w-5 h-5 text-blue-800' />
